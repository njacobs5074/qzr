...
public class HrMaxQuizController {
    ...
    public QuizResource getQuiz() {
        ...
        try {
            ...
            quiz.add(linkTo(methodOn(HrMaxQuizController.class).getQuestions()).withRel("questions"));
     ...
     * Find a specific question which has been asked.
     *
     * @param key    The unique key of the question being answered.
     * @param answer The details of the answer.
     * @return The answer.
     * @throws BadRequestException If the answer can't be parsed. Perhaps it's supposed to be a
     ...
     * @throws NotFoundException If the question cannot be found or no answer has yet been
     *                           provided to it.
     */
